      ...
      <header className="border-b border-neutral-800 bg-neutral-900/50 backdrop-blur">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-neutral-500">for merchants</span>
          </div>
          <a
            href="/"
      ...
      <div className="mx-auto max-w-5xl px-6 py-10">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <section className="rounded-lg border border-neutral-800 bg-neutral-900/50 p-6">
            <div className="mb-4 flex items-center gap-3">
              <Step n={2} />
              <h2 className="text-lg font-semibold">Your ENS identity</h2>
            </div>
          ...
          <section className="rounded-lg border border-neutral-800 bg-neutral-900/50 p-6 lg:col-span-2">
            <div className="mb-4 flex items-center gap-3">
              <Step n={3} />
          ...
          <section className="rounded-lg border border-amber-700/40 bg-amber-950/20 p-6 lg:col-span-2">
        ...
        <section className="mt-10">
          ...
          <div className="mt-3 grid gap-3 sm:grid-cols-2">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="block rounded-md border border-emerald-800/40 bg-emerald-950/20 p-4 text-sm transition hover:border-emerald-700/60"
            >
              <div className="font-mono text-emerald-300">merchant-a.safespend.eth</div>
            ...
            <a
              ...
              className="block rounded-md border border-emerald-800/40 bg-emerald-950/20 p-4 text-sm transition hover:border-emerald-700/60"
            >
              <div className="font-mono text-emerald-300">merchant-b.safespend.eth</div>
              <div className="mt-1 font-mono text-xs text-neutral-500">
